...
export class UserInfoApi extends runtime.BaseAPI {
     ...
     */
    async getUserInfoByIdRaw(requestParameters: GetUserInfoByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetUserInfo200Response>> {
     ...
     * returns user info by user id
     */
    async getUserInfoById(requestParameters: GetUserInfoByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetUserInfo200Response> {
